...
KomaruGram отправляет анонимную статистику в Google Analytics: запуски, обновления и факт
сбоя с версией, в которой он произошёл. К ним прикладывается случайный ID, не связанный с
