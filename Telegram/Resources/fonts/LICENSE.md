...
KomaruGram ships the font files in this directory so the font picker
offers them on machines where they are not installed. Each family keeps
its own licence; the full texts follow.

- **Inter** — SIL Open Font License 1.1 — https://github.com/rsms/inter
- **Roboto** — Apache License 2.0 — https://github.com/googlefonts/roboto
- **Open Sans** — SIL Open Font License 1.1 — https://github.com/googlefonts/opensans
- **Lato** — SIL Open Font License 1.1 — https://github.com/google/fonts/tree/main/ofl/lato
