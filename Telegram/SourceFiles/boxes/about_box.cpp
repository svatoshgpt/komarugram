...
rpl::producer<TextWithEntities> Text() {
	return tr::lng_about_text2(
		...
		rpl::single(Ui::Text::Link(
			"GNU GPL",
			"https://github.com/svatoshgpt/komarugram/blob/main/LICENSE")),
		lt_github_link,
		rpl::single(Ui::Text::Link(
			"GitHub",
			"https://github.com/svatoshgpt/komarugram")),
		tr::marked);
}
...
void AboutBox(not_null<Ui::GenericBox*> box, Window::SessionController* controller) {
	box->setTitle(rpl::single(u"KomaruGram"_q));
	...
	box->addLeftButton(
		...
		[=] {
			File::OpenUrl(u"https://github.com/svatoshgpt/komarugram/releases"_q);
		});
