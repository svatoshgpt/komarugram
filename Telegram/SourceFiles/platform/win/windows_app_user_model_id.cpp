...
#ifdef OS_WIN_STORE
const WCHAR AppUserModelIdBase[] = L"KomaruGram.KomaruGram.Store";
#else // OS_WIN_STORE
const WCHAR AppUserModelIdBase[] = L"KomaruGram.KomaruGram";
#endif // OS_WIN_STORE
...
void CleanupShortcut() {
	...
	QString path = systemShortcutPath() + u"KomaruGram.lnk"_q;
...
bool checkInstalled(QString path = {}) {
	...
	const auto installed = u"KomaruGram/KomaruGram.lnk"_q;
	const auto old = u"KomaruGram for Windows/KomaruGram.lnk"_q;
